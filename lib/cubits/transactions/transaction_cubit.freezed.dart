...
mixin _$TransactionState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Transactions> pendingTransactions,
            List<Transactions> successfulTransactions,
            List<Transactions> cancelledTransactions)
        success,
...
class _$_Success implements _Success {
  const _$_Success(
      {required final List<Transactions> pendingTransactions,
      required final List<Transactions> successfulTransactions,
      required final List<Transactions> cancelledTransactions})
      : _pendingTransactions = pendingTransactions,
        _successfulTransactions = successfulTransactions,
        _cancelledTransactions = cancelledTransactions;
  ...
  @override
  String toString() {
    return 'TransactionState.success(pendingTransactions: $pendingTransactions, successfulTransactions: $successfulTransactions, cancelledTransactions: $cancelledTransactions)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other._successfulTransactions, _successfulTransactions) &&
            const DeepCollectionEquality()
                .equals(other._cancelledTransactions, _cancelledTransactions));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_successfulTransactions),
      const DeepCollectionEquality().hash(_cancelledTransactions));
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(
        pendingTransactions, successfulTransactions, cancelledTransactions);
  }
...
abstract class _Success implements TransactionState {
  const factory _Success(
      {required final List<Transactions> pendingTransactions,
      required final List<Transactions> successfulTransactions,
      required final List<Transactions> cancelledTransactions}) = _$_Success;
...
class __$$_FailedCopyWithImpl<$Res>
    extends _$TransactionStateCopyWithImpl<$Res, _$_Failed>
...
class _$_Failed implements _Failed {
  ...
  @override
  String toString() {
    return 'TransactionState.failed(error: $error)';
  }
