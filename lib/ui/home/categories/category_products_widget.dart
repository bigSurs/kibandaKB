...
import 'package:kibanda_kb/cubits/cubit/ui_cubits/selected_variation_cubit/selected_variation_cubit.dart';
...
class CategoryProductsWidget extends StatelessWidget {
  ...
  const CategoryProductsWidget({Key? key, required this.products})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return ExpandedCategoriesProductWidget(
            isDialog: false,
...
class ExpandedCategoriesProductWidget extends StatefulWidget {
  final VendorProducts product;
  final bool isDialog;
  const ExpandedCategoriesProductWidget({
    Key? key,
  ...
  State<ExpandedCategoriesProductWidget> createState() =>
      _ExpandedCategoriesProductWidgetState();
}

class _ExpandedCategoriesProductWidgetState
                          ...
                          : CupertinoButton(
                              onPressed: () {
                                context.read<CartCubit>().addToCart(
                                    product: widget.product, variation: {});
                                if (widget.isDialog) {
                                  Navigator.pop(context);
                                }
                              },
