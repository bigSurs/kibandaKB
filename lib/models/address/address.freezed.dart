...
/// @nodoc
mixin _$Address {
  String? get address_id => throw _privateConstructorUsedError;
  ...
  String? get flat_number => throw _privateConstructorUsedError;
...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_id: $address_id, name: $name, contact_no: $contact_no, address: $address, city_id: $city_id, flat_number: $flat_number, latitude: $latitude, longitude: $longitude, building_name: $building_name, landmark: $landmark, city: $city, zipcode: $zipcode, address_type: $address_type, update: $update, delete: $delete)';
  }
...
abstract class _Address implements Address {
  factory _Address(
      ...
      final String? address_type,
      final String? update,
      final String? delete}) = _$_Address;
