...
mixin _$ProductCategory {
  ...
  String? get thumb_two => throw _privateConstructorUsedError;
  int? get products_count => throw _privateConstructorUsedError;
...
class _$_ProductCategory implements _ProductCategory {
  ...
  final String? thumb;
  @override
  final String? thumb_two;
  @override
  final int? products_count;

  @override
  String toString() {
    return 'ProductCategory(category_id: $category_id, image: $image, description: $description, meta_description: $meta_description, name: $name, parent_id: $parent_id, status: $status, sort_order: $sort_order, thumb: $thumb, thumb_two: $thumb_two, products_count: $products_count)';
  }
...
abstract class _ProductCategory implements ProductCategory {
  factory _ProductCategory(
      ...
      final String? thumb,
      final String? thumb_two,
      final int? products_count}) = _$_ProductCategory;
  ...
  String? get thumb;
  @override
  String? get thumb_two;
  @override
  int? get products_count;
  @override
  @JsonKey(ignore: true)
  _$$_ProductCategoryCopyWith<_$_ProductCategory> get copyWith =>
      throw _privateConstructorUsedError;
