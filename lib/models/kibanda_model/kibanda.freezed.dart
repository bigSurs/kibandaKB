...
Kibanda _$KibandaFromJson(Map<String, dynamic> json) {
  return _Kibanda.fromJson(json);
}
...
mixin _$Kibanda {
  ...
  @JsonKey(ignore: true)
  $KibandaCopyWith<Kibanda> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
abstract class _$$_KibandaCopyWith<$Res> implements $KibandaCopyWith<$Res> {
  factory _$$_KibandaCopyWith(
...
/// @nodoc
@JsonSerializable()
class _$_Kibanda implements _Kibanda {
  _$_Kibanda(
      {this.customer_id,
  ...
  factory _$_Kibanda.fromJson(Map<String, dynamic> json) =>
      _$$_KibandaFromJson(json);
  ...
  @override
  final String? customer_category;
  ...
  Map<String, dynamic> toJson() {
    return _$$_KibandaToJson(
      this,
    );
  }
}

abstract class _Kibanda implements Kibanda {
  factory _Kibanda(
      {final num? customer_id,
      final num? customer_group_id,
      final num? store_id,
  ...
  factory _Kibanda.fromJson(Map<String, dynamic> json) = _$_Kibanda.fromJson;
